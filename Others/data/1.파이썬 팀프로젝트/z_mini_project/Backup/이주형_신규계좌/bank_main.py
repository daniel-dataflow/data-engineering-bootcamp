...
# 다른 클래스들을 호출하는 클래스
class Main:
    def __init__(self, per, acc, loan=None):
        self.per = per
        self.acc = acc
        self.loan = loan
    ...
    def account_main(self, choice):
        if choice == "0":
            ...
            return "deposit_withdraw"  # Signal to show deposit/withdraw menu
        elif choice == "5":
            return "loan"  # Signal to show loan menu
        elif choice == "8":
            return False
        elif choice == "9":
            print("프로그램을 종료합니다.")
